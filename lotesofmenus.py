...
menuItem3 = MenuItem(user_id=1, name="Gyoza", description="light seasoning "
                     "of Japanese gyoza with salt and soy sauce, and "
...
menuItem2 = MenuItem(user_id=1, name="Mushroom risotto", description="Porta"
                     "bello mushrooms in a creamy risotto",
                     price="$5.99", course="Entree", restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1, name="Cauliflower Manchurian", description="G"
                     "olden fried cauliflower florets in a midly spiced "
                     "soya,garlic sauce cooked with fresh cilantro, "
...
menuItem3 = MenuItem(user_id=1, name="Mom's Spaghetti", description="Spaghett"
                     "i with some incredible tomato sauce made by mom",
...
menuItem4 = MenuItem(user_id=1, name="Choc Full O\' Mint (Smitten\'s Fresh "
                     ...
                     "nitrogen magic", price="$3.95", course="Dessert",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1, name="Lamb Curry", description="Slow cook tha"
                     "t thang in a pool of tomatoes, onions and alllll those"
...
menuItem4 = MenuItem(user_id=1, name="Tandoori Chicken", description="Chicken"
                     ...
                     "mix(chilli, tamarind among others) and slow cooked in "
                     "a cylindrical clay or metal oven which gets its heat "
...
menuItem10 = MenuItem(user_id=1, name="Spinach Ice Cream", description="vanil"
                      "la ice cream made with organic spinach leaves",
